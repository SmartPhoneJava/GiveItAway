					...
					<Answer
						...
						text={
							<>
								...
								<i>аукцион</i>. Если выбрать <i>сделку</i> или <i>лотерею</i>, то за передачу вещи ты
								получишь столько кармы, сколько человек откликнулось на объявление. Если же тип
								объявления <i>аукцион</i>, то при передачи вещи ты получишь число кармы, равное
								максимальной ставки аукциона.
							</>
						}
					/>,
					<Answer
