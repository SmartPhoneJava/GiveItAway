...
export const PANEL_CATEGORIES_B = 'categories b';
export const PANEL_SUBCATEGORIES_B = 'subcategories b';
export const PANEL_SUBSUBCATEGORIES_B = 'subsubcategories b';
